    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b-2 border-black">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <a href="#" className="hover:opacity-80 transition-opacity">
          <img src="/SIXTEEN LG 2K26 PNG 2.png" alt="Sixteen Design Logo" className="max-h-[40px] md:max-h-[50px] w-auto object-contain" />
        </a>
        ...
        <a
          ...
          className="bg-sixteen-orange px-3 py-1 md:px-6 md:py-2 font-body font-bold text-xs md:text-sm uppercase tracking-widest border-2 border-black neo-border-sm hover:bg-black hover:text-white transition-all"
        >
          Orçamento
        </a>
      </div>
